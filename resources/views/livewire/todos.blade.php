<div>
    <form class="flex flex-col gap-4" wire:submit.prevent="addTodo">
        <div class=" flex flex-1 text-xl mb-4">
            <input type="text" name='addTodo' id="addTodo" wire:model="title" placeholder="Enter a Todo..."
                class="w-full bg-white text-slate-600">
...
<div x-data="noticesHandler()" class="fixed inset-0 flex flex-col-reverse items-end justify-start h-screen w-screen"
